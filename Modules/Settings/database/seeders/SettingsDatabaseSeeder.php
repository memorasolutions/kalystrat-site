...
class SettingsDatabaseSeeder extends Seeder
{
    public function run(): void
    {
        $defaults = [
            ...
            // AI - administration
            ['group' => 'ai', 'key' => 'ai.admin_email', 'value' => '', 'type' => 'string', 'description' => 'Courriel admin pour les digests chatbot'],
            ['group' => 'ai', 'key' => 'ai.system_prompt', 'value' => '', 'type' => 'text', 'description' => 'Prompt système du chatbot (vide = fichier par défaut)'],

            // Newsletter
            ['group' => 'newsletter', 'key' => 'newsletter.digest_enabled', 'value' => 'true', 'type' => 'boolean', 'description' => 'Activer l\'envoi de digests newsletter'],

            // Privacy
            ['group' => 'legal', 'key' => 'cookie_policy_version', 'value' => '1', 'type' => 'number', 'description' => 'Version de la politique de cookies (incrémenté = demander nouveau consentement)'],

            // Branding - couleurs et typographie avancées
            ['group' => 'branding', 'key' => 'branding.secondary_color', 'value' => '#7987a1', 'type' => 'string', 'description' => 'Couleur secondaire'],
            ['group' => 'branding', 'key' => 'branding.sidebar_bg', 'value' => '#0c1427', 'type' => 'string', 'description' => 'Couleur de fond de la sidebar'],
            ['group' => 'branding', 'key' => 'branding.success_color', 'value' => '#05a34a', 'type' => 'string', 'description' => 'Couleur de succès'],
            ['group' => 'branding', 'key' => 'branding.topbar_font_family', 'value' => 'Roboto', 'type' => 'string', 'description' => 'Police de la barre de navigation'],
            ['group' => 'branding', 'key' => 'branding.topbar_font_size', 'value' => '1rem', 'type' => 'string', 'description' => 'Taille de police topbar'],
            ['group' => 'branding', 'key' => 'branding.topbar_font_weight', 'value' => '400', 'type' => 'string', 'description' => 'Poids de police topbar'],
            ['group' => 'branding', 'key' => 'branding.topbar_letter_spacing', 'value' => 'normal', 'type' => 'string', 'description' => 'Espacement lettres topbar'],
            ['group' => 'branding', 'key' => 'branding.topbar_word_spacing', 'value' => 'normal', 'type' => 'string', 'description' => 'Espacement mots topbar'],
            ['group' => 'branding', 'key' => 'branding.topbar_text_transform', 'value' => 'none', 'type' => 'string', 'description' => 'Transformation texte topbar'],
        ];
