...
<div class="page-content">
    <div class="d-flex align-items-center justify-content-between mb-4">
        <h4 class="mb-0">{{ __('Créer un menu') }}</h4>
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('admin.menus.store') }}" method="POST">
                ...
                <div class="mb-3">
                    <label for="name" class="form-label">{{ __('Nom du menu') }} <span class="text-danger">*</span></label>
                ...
                <div class="mb-3">
                    <label for="location" class="form-label">{{ __('Emplacement') }}</label>
                ...
                <button type="submit" class="btn btn-primary">
                    <i data-lucide="save"></i> {{ __('Créer le menu') }}
                </button>
            </form>
        </div>
    </div>
