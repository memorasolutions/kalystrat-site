...
<div class="page-content">
    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            {{-- Add item panel --}}
            <div class="card mb-3">
                <div class="card-header"><h5 class="card-title mb-0">{{ __('Ajouter un élément') }}</h5></div>
                <div class="card-body">
                    <ul class="nav nav-tabs nav-tabs-sm" role="tablist">
                        ...
                        <li class="nav-item"><button class="nav-link" data-bs-toggle="tab" data-bs-target="#tab-categories">{{ __('Catégories') }}</button></li>
                        @endif
                    </ul>
            ...
            {{-- Menu settings --}}
            <div class="card">
                <div class="card-header"><h5 class="card-title mb-0">{{ __('Paramètres') }}</h5></div>
                <div class="card-body">
        ...
        <div class="col-lg-8">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="card-title mb-0">{{ __('Structure du menu') }}</h5>
                ...
                <div class="card-body">
                    <p class="text-muted small mb-3">{{ __('Glissez-déposez pour réorganiser. Indentez pour créer des sous-menus.') }}</p>
                    ...
                    <div class="text-center py-4 text-muted" id="emptyState">
                        ...
                        <p>{{ __('Ajoutez des éléments depuis le panneau de gauche.') }}</p>
                    </div>
                    @endif
                </div>
            </div>
...
function removeItem(btn) {
    if (confirm('{{ __("Supprimer cet élément ?") }}')) {
        ...
        <div class="item-body">
            <div class="row g-2">
                ...
                <div class="col-4">
                    ...
                    <input type="text" class="form-control form-control-sm field-icon" value="${data.icon||''}" placeholder="{{ __('lucide icon name') }}">
                </div>
                <div class="col-4">
...
function addCustomItem() {
    ...
    if (!title) { alert('{{ __("Le titre est requis.") }}'); return; }
