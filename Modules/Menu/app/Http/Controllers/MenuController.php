...
class MenuController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        return redirect()->route('admin.menus.edit', $menu)
            ->with('success', __('Menu créé avec succès.'));
    }
    ...
    public function update(Request $request, Menu $menu): RedirectResponse
    {
        ...
        return redirect()->back()->with('success', __('Menu mis à jour avec succès.'));
    }
    ...
    public function destroy(Menu $menu): RedirectResponse
    {
        ...
        return redirect()->route('admin.menus.index')
            ->with('success', __('Menu supprimé avec succès.'));
    }
    ...
    public function saveItems(Request $request, Menu $menu): JsonResponse
    {
        ...
        return response()->json(['success' => true, 'message' => __('Éléments du menu enregistrés.')]);
    }
    ...
    private function getLinkableOptions(): array
    {
        ...
        if (class_exists(StaticPage::class)) {
            $options['pages'] = StaticPage::where('status', 'published')
                ->get(['id', 'title', 'slug']);
        }

        if (class_exists(Category::class)) {
            $options['categories'] = Category::all(['id', 'name', 'slug']);
        }
