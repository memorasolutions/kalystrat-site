...
class StaticPageController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        return redirect()->route('admin.pages.index')->with('success', __('Page créée avec succès.'));
    }
    ...
    public function update(Request $request, StaticPage $page): RedirectResponse
    {
        ...
        return redirect()->route('admin.pages.index')->with('success', __('Page mise à jour.'));
    }
    ...
    public function destroy(StaticPage $page): RedirectResponse
    {
        ...
        return redirect()->route('admin.pages.index')->with('success', __('Page supprimée.'));
    }
}
