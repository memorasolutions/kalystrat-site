...
@extends('backoffice::themes.backend.layouts.admin', ['title' => __('Modifier la page'), 'subtitle' => __('Pages statiques')])
                ...
                <div class="p-4">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control bg-light text-muted"
                               value="{{ $page->slug }}" readonly aria-label="{{ __('Slug') }}">
                        <div class="form-text text-muted">{{ __('Non modifiable après création') }}</div>
                    </div>
            ...
            <div class="card mb-3">
                ...
                <div class="p-4">
                    <div class="mb-0">
                        ...
                        <input type="text" class="form-control" id="content_password" name="content_password" value="{{ old('content_password', $page->content_password ?? '') }}" placeholder="{{ __('Laisser vide pour accès libre') }}">
                    </div>
                </div>
            </div>
