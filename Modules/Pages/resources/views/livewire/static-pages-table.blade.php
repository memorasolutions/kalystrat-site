    ...
    <div class="table-responsive">
        <table class="table table-sm mb-0">
            ...
            <tbody>
                        ...
                        <td>
                            <div class="d-flex align-items-center justify-content-center gap-2">
                                <a href="{{ route('pages.show', $page->slug) }}" target="_blank"
                                   ...
                                   title="{{ __('Voir public') }}" style="width:30px;height:30px;">
                                    <i data-lucide="eye"></i>
                                </a>
                                <a href="{{ route('admin.pages.edit', $page->slug) }}"
                                   class="btn btn-sm btn-outline-primary rounded-circle p-1"
                                   title="{{ __('Modifier') }}" style="width:30px;height:30px;">
                                ...
                                <button wire:click="deletePage({{ $page->id }})"
                                        ...
                                        title="{{ __('Supprimer') }}" style="width:30px;height:30px;">
                ...
                @empty
                    <tr>
                        <td colspan="5" class="py-4 text-center text-muted">{{ __('Aucune page trouvée') }}</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
