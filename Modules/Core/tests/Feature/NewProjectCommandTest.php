...
function buildCommand(PendingCommand $command, array $businessAnswers = [], array $advancedAnswers = []): PendingCommand
{
...
test('core:new-project command is registered with categorized modules', function () {
    expect(class_exists(NewProjectCommand::class))->toBeTrue();
});

test('core:new-project has correct module constants', function () {
    $reflection = new ReflectionClass(NewProjectCommand::class);
