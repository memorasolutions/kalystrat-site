...
use Modules\Core\Console\AuditCommand;
use Modules\Core\Console\CleanupOldRecords;
use Modules\Core\Console\CoreSetupCommand;
use Modules\Core\Console\MakeCrudCommand;
use Modules\Core\Console\NewProjectCommand;
...
class CoreServiceProvider extends ServiceProvider
{
    ...
    {
        $this->commands([
            CoreSetupCommand::class,
            MakeCrudCommand::class,
            NewProjectCommand::class,
            CleanupOldRecords::class,
            AuditCommand::class,
        ]);
    }
    ...
    {
        $configPath = module_path($this->name, (string) config('modules.paths.generator.config.path'));
