...
class {$model}Controller extends Controller
{
    ...
    public function store(Request \$request): RedirectResponse
    {
        ...
        return redirect()->route('{$moduleL}.{$plural}.index')->with('success', __('{$model} créé avec succès.'));
    }
    ...
    public function update(Request \$request, int \$id): RedirectResponse
    {
        ...
        return redirect()->route('{$moduleL}.{$plural}.index')->with('success', __('{$model} mis à jour avec succès.'));
    }

    public function destroy(int \$id): RedirectResponse
    {
        \$this->service->delete(\$id);
        return redirect()->route('{$moduleL}.{$plural}.index')->with('success', __('{$model} supprimé avec succès.'));
    }
}
PHP;
        $this->writeFile($path, $stub);
