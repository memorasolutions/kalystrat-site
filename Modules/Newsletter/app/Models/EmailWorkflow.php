...
use Modules\Newsletter\Database\Factories\EmailWorkflowFactory;
...
class EmailWorkflow extends Model
{
    ...
    protected static function newFactory(): EmailWorkflowFactory
    {
        return EmailWorkflowFactory::new();
    }
}
