...
class NewsletterController extends Controller
{
    public function subscribe(Request $request): RedirectResponse
    {
        ...
        return back()->with('newsletter_success', __('Vérifiez votre courriel pour confirmer votre abonnement !'));
    }
    ...
    public function confirm(string $token): RedirectResponse
    {
        ...
        return redirect('/')->with('newsletter_confirmed', __('Abonnement confirmé ! Merci.'));
    }
    ...
    public function unsubscribe(string $token): View|RedirectResponse
    {
        ...
        return redirect('/')->with('newsletter_unsubscribed', __('Vous avez été désabonné avec succès.'));
    }
}
