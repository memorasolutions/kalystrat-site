...
<div class="row g-3">
    <div class="col-xl-8">
        <div class="card">
            <div class="card-header py-3 px-4 border-bottom d-flex align-items-center justify-content-between">
                <h5 class="fw-bold mb-0">{{ __('Nouvelle campagne') }}</h5>
    ...
    <div class="col-xl-4">
        <div class="card mb-3">
            ...
            <div class="p-4">
                <p class="small text-muted mb-3">La campagne sera créée en statut <strong class="text-body">{{ __('brouillon') }}</strong>.</p>
