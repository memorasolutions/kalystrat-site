...
@extends('admintabler::layouts.admin', ['title' => 'Modifier template', 'subtitle' => 'Newsletter'])
                ...
                <form method="POST" action="{{ route('admin.newsletter.templates.update', $template) }}">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="category" class="form-control @error('category') is-invalid @enderror" value="{{ old('category', $template->category) }}" placeholder="{{ __('Ex: onboarding') }}">
