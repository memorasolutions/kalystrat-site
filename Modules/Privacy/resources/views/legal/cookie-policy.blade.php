...
<div class="prose max-w-none mx-auto">
    ...
    <p>{{ __('Les cookies (ou témoins de connexion) sont de petits fichiers texte déposés sur votre appareil lorsque vous visitez notre site. Ils permettent au site de mémoriser vos actions et préférences sur une période donnée. Conformément à la Loi 25 du Québec (art. 8.1), les témoins non essentiels sont désactivés par défaut tant que vous n\'avez pas donné votre consentement.') }}</p>
