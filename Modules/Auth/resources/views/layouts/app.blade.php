                ...
                <ul class="nav" id="sidebarNav">
                    ...
                    <li class="nav-item {{ request()->routeIs('user.dashboard') ? 'active' : '' }}">
                        <a href="{{ route('user.dashboard') }}" class="nav-link">
                            <i class="link-icon" aria-hidden="true" data-lucide="home"></i>
                    ...
                    <li class="nav-item {{ request()->routeIs('user.articles.*') ? 'active' : '' }}">
                        <a class="nav-link" data-bs-toggle="collapse" href="#articlesMenu" role="button"
                           aria-expanded="{{ request()->routeIs('user.articles.*') ? 'true' : 'false' }}">
                            <i class="link-icon" aria-hidden="true" data-lucide="file-text"></i>
                            <span class="link-title">{{ __('Mes articles') }}</span>
                            <i class="link-arrow" aria-hidden="true" data-lucide="chevron-down"></i>
                        </a>
                    ...
                    <li class="nav-item {{ request()->routeIs('user.notifications') ? 'active' : '' }}">
                        <a href="{{ route('user.notifications') }}" class="nav-link">
                            <i class="link-icon" aria-hidden="true" data-lucide="bell"></i>
                    ...
                    <li class="nav-item {{ request()->routeIs('user.profile') ? 'active' : '' }}">
                        <a href="{{ route('user.profile') }}" class="nav-link">
                            <i class="link-icon" aria-hidden="true" data-lucide="user"></i>
                    ...
                    <li class="nav-item {{ request()->routeIs('user.sessions') ? 'active' : '' }}">
                        <a href="{{ route('user.sessions') }}" class="nav-link">
                            <i class="link-icon" aria-hidden="true" data-lucide="monitor"></i>
                    ...
                    <li class="nav-item {{ request()->routeIs('user.subscription', 'user.invoices') ? 'active' : '' }}">
                        <a href="{{ route('user.subscription') }}" class="nav-link">
                            <i class="link-icon" aria-hidden="true" data-lucide="credit-card"></i>
                    ...
                    <li class="nav-item {{ request()->routeIs('customer.orders*') ? 'active' : '' }}">
                        <a href="{{ route('customer.orders') }}" class="nav-link">
                            <i class="link-icon" aria-hidden="true" data-lucide="shopping-bag"></i>
                    ...
                    <li class="nav-item {{ request()->routeIs('customer.addresses*') ? 'active' : '' }}">
                        <a href="{{ route('customer.addresses') }}" class="nav-link">
                            <i class="link-icon" aria-hidden="true" data-lucide="map-pin"></i>
                    ...
                    <li class="nav-item {{ request()->routeIs('customer.downloads') ? 'active' : '' }}">
                        <a href="{{ route('customer.downloads') }}" class="nav-link">
                            <i class="link-icon" aria-hidden="true" data-lucide="download"></i>
                    ...
                    <li class="nav-item {{ request()->routeIs('user.bookings*') ? 'active' : '' }}">
                        <a href="{{ route('user.bookings.index') }}" class="nav-link">
                            <i class="link-icon" aria-hidden="true" data-lucide="calendar"></i>
                    ...
                    @if(auth()->user()->hasAnyRole(['admin', 'super_admin']))
                        ...
                        <li class="nav-item">
                            <a href="{{ url('/admin') }}" class="nav-link">
                                <i class="link-icon" aria-hidden="true" data-lucide="shield"></i>
            ...
            <nav class="navbar">
                <div class="navbar-content">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <div class="theme-switcher-wrapper d-flex align-items-center px-2">
                                ...
                                <label for="theme-switcher" class="label d-flex align-items-center gap-1 cursor-pointer mb-0" style="cursor:pointer;">
                                    <i data-lucide="sun" aria-hidden="true" style="width:16px;height:16px;"></i>
                                    <span class="ball"></span>
                                    <i data-lucide="moon" aria-hidden="true" style="width:16px;height:16px;"></i>
                                </label>
                            </div>
                        </li>
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle d-flex align-items-center" href="#"
                               data-bs-toggle="dropdown" aria-expanded="false">
                                ...
                                <img src="{{ asset('build/nobleui/plugins/flag-icons/flags/4x3/' . ($currentLocale === 'fr' ? 'fr' : 'us') . '.svg') }}"
                                     class="w-20px" alt="{{ $currentLocale === 'fr' ? __('Français') : __('English') }}">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                <a class="dropdown-item d-flex align-items-center gap-2" href="{{ route('locale.switch', 'fr') }}">
                                    <img src="{{ asset('build/nobleui/plugins/flag-icons/flags/4x3/fr.svg') }}" class="w-20px" alt="{{ __('Français') }}">
                                    Français
                                </a>
                                <a class="dropdown-item d-flex align-items-center gap-2" href="{{ route('locale.switch', 'en') }}">
                                    <img src="{{ asset('build/nobleui/plugins/flag-icons/flags/4x3/us.svg') }}" class="w-20px" alt="{{ __('English') }}">
                                    English
                                </a>
                            </div>
                        </li>
                        ...
                        {{-- Notifications --}}
                        <li class="nav-item">
                            <a href="{{ route('user.notifications') }}" class="nav-link position-relative" aria-label="{{ __('Notifications') }}">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end p-0" style="min-width:220px;">
                                <div class="d-flex align-items-center gap-3 p-3 border-bottom">
                                    @if(auth()->user()->avatar)
                                        <img src="{{ asset('storage/' . auth()->user()->avatar) }}"
                                             class="rounded-circle" width="50" height="50" alt="{{ auth()->user()->name ?? __('Avatar') }}">
                                    @else
                                        <span class="rounded-circle d-flex align-items-center justify-content-center text-white fw-bold"
                                ...
                                <div class="py-2">
                                    <a class="dropdown-item d-flex align-items-center gap-2 py-2" href="{{ route('user.profile') }}">
                                        <i data-lucide="user" aria-hidden="true" style="width:16px;height:16px;"></i>
                                        {{ __('Profil') }}
                                    </a>
                                    <a class="dropdown-item d-flex align-items-center gap-2 py-2" href="{{ route('user.notifications') }}">
                                        <i data-lucide="bell" aria-hidden="true" style="width:16px;height:16px;"></i>
                                        {{ __('Notifications') }}
                                        @if(($unreadCount ?? 0) > 0)
                                    ...
                                    <a class="dropdown-item d-flex align-items-center gap-2 py-2" href="{{ route('user.subscription') }}">
                                        <i data-lucide="credit-card" aria-hidden="true" style="width:16px;height:16px;"></i>
                                        {{ __('Abonnement') }}
                                    </a>
                                    <a class="dropdown-item d-flex align-items-center gap-2 py-2" href="{{ route('user.sessions') }}">
                                        <i data-lucide="monitor" aria-hidden="true" style="width:16px;height:16px;"></i>
                                        {{ __('Sessions') }}
                                    </a>
                                    <a class="dropdown-item d-flex align-items-center gap-2 py-2" href="{{ route('user.activity') }}">
                                        <i data-lucide="activity" aria-hidden="true" style="width:16px;height:16px;"></i>
                                        {{ __('Activité') }}
                                    </a>
                                    @if(auth()->user()->hasRole(['admin', 'super_admin']))
                                        <div class="dropdown-divider"></div>
                                        <a class="dropdown-item d-flex align-items-center gap-2 py-2" href="{{ route('admin.dashboard') }}">
                                            <i data-lucide="shield" aria-hidden="true" style="width:16px;height:16px;"></i>
                                            {{ __('Administration') }}
                                        </a>
                                    @endif
                                    <div class="dropdown-divider"></div>
                                    <form method="POST" action="{{ route('logout') }}" id="user-logout-form">
                                        ...
                                        <button type="button" class="dropdown-item d-flex align-items-center gap-2 py-2 text-danger"
                                            ...
                                            <i data-lucide="log-out" aria-hidden="true" style="width:16px;height:16px;"></i>
                                            {{ __('Déconnexion') }}
                                        </button>
                                    </form>
                                </div>
            ...
            <div class="page-content container-xxl">
                ...
                @if(session('success'))
                    <div class="alert alert-success d-flex align-items-center gap-2 alert-dismissible fade show mb-3" role="alert"
                        ...
                        <i data-lucide="check-circle" aria-hidden="true" class="icon-sm"></i>
                        {{ session('success') }}
                ...
                @if(session('error'))
                    <div class="alert alert-danger d-flex align-items-center gap-2 alert-dismissible fade show mb-3" role="alert"
                         x-data="{ show: true }" x-show="show" x-transition>
                        <i data-lucide="alert-circle" aria-hidden="true" class="icon-sm"></i>
                        {{ session('error') }}
                        <button type="button" class="btn-close" @click="show = false" aria-label="Fermer"></button>
                    </div>
                @endif
                ...
                @if(session('warning'))
                    <div class="alert alert-warning d-flex align-items-center gap-2 alert-dismissible fade show mb-3" role="alert"
                         x-data="{ show: true }" x-show="show" x-transition>
                        <i data-lucide="alert-triangle" aria-hidden="true" class="icon-sm"></i>
                        {{ session('warning') }}
                        <button type="button" class="btn-close" @click="show = false" aria-label="Fermer"></button>
                    </div>
                @endif
