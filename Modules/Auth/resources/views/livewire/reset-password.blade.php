...
<div>
    ...
    <p class="mt-2 text-base text-gray-700">{{ __('Choisissez un nouveau mot de passe pour votre compte.') }}</p>
            ...
            <div>
                ...
                <div class="mt-2 relative">
                    ...
                    <input wire:model="email" type="email" id="reset-email" autocomplete="email"
                           ...
                           required aria-required="true" aria-describedby="reset-email-error">
                </div>
                @error('email')<p class="text-red-600 text-sm mt-1" id="reset-email-error" role="alert">{{ $message }}</p>@enderror
            </div>
            ...
            <div>
                ...
                <div class="mt-2 relative">
                    ...
                    <input wire:model="password" type="password" id="reset-password"
                           ...
                           placeholder="{{ __('Nouveau mot de passe') }}" required aria-required="true" aria-describedby="reset-password-error">
                    <button type="button"
                        ...
                        <i class="ti ti-eye text-xl toggle-eye-reset-password" aria-hidden="true"></i>
                    </button>
                </div>
                @error('password')<p class="text-red-600 text-sm mt-1" id="reset-password-error" role="alert">{{ $message }}</p>@enderror
            </div>
            ...
            <div>
                ...
                <div class="mt-2 relative">
                    ...
                    <button type="button"
                            ...
                            aria-label="{{ __('Afficher le mot de passe') }}">
                        <i class="ti ti-eye text-xl toggle-eye-reset-password-confirm" aria-hidden="true"></i>
                    </button>
                </div>
            </div>
