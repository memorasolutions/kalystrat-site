...
<div>
    ...
    <p class="mt-2 text-base text-gray-700">{{ __('Entrez vos informations pour commencer') }}</p>
            ...
            <div>
                ...
                <div class="mt-2 relative">
                    <div class="absolute inset-y-0 start-0 flex items-center ps-3 pointer-events-none">
                        <i class="ti ti-user text-gray-400 text-xl" aria-hidden="true"></i>
                    </div>
                    <input wire:model="name" type="text" id="register-name" autocomplete="name"
                           ...
                           placeholder="{{ __('Nom complet') }}" required autofocus aria-required="true" aria-describedby="register-name-error">
                </div>
                @error('name')<p class="text-red-600 text-sm mt-1" id="register-name-error" role="alert">{{ $message }}</p>@enderror
            </div>
            ...
            <div>
                ...
                <div class="mt-2 relative">
                    ...
                    <input wire:model="email" type="email" id="register-email" autocomplete="email"
                           class="block w-full py-4 ps-10 pe-4 text-black placeholder-gray-500 transition-all duration-200 border border-gray-200 rounded-md bg-gray-50 focus:outline-none focus:border-sky-600 focus:bg-white caret-sky-600"
                           placeholder="{{ __('votre@courriel.com') }}" required aria-required="true" aria-describedby="register-email-error">
                </div>
                @error('email')<p class="text-red-600 text-sm mt-1" id="register-email-error" role="alert">{{ $message }}</p>@enderror
            </div>
            ...
            <div x-data="{
                ...
                <div class="mt-2 relative">
                    ...
                    <input wire:model="password" x-model="pwd" type="password" id="register-password" autocomplete="new-password"
                           ...
                           placeholder="{{ __('Mot de passe') }}" required aria-required="true" aria-describedby="register-password-error">
                    <button type="button"
                        ...
                        <i class="ti ti-eye text-xl toggle-eye-register-password" aria-hidden="true"></i>
                    </button>
                </div>
