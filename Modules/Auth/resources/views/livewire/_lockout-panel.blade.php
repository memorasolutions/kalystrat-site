...
<div class="space-y-4 mt-6" x-data="{ showContact: false }">
    ...
    <div class="rounded-lg bg-amber-50 border border-amber-200 p-4">
        <div class="flex items-start">
            <i class="ti ti-lock text-amber-600 text-xl flex-shrink-0 mt-0.5" aria-hidden="true"></i>
            <div class="ml-3 flex-1">
                ...
                <div class="mt-3 flex flex-col gap-2">
                    <a href="{{ route('password.request') }}"
                       class="inline-flex items-center text-sm font-medium text-sky-800 hover:text-sky-800 hover:underline">
                        <i class="ti ti-key mr-1.5" aria-hidden="true"></i>
                        {{ __('Réinitialiser mon mot de passe') }}
                    </a>
                    <button type="button" @click="showContact = !showContact"
                            class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-gray-800">
                        <i class="ti ti-lifebuoy mr-1.5" aria-hidden="true"></i>
