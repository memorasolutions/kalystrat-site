...
<p class="mt-2 text-base text-gray-700">{{ __('Cette action nécessite de confirmer votre mot de passe pour continuer.') }}</p>
...
<div class="mt-6 text-center">
    <a href="{{ route('user.dashboard') }}" class="font-medium text-sky-800 transition-all duration-200 hover:text-sky-800 focus:text-sky-800 hover:underline">
