...
<div>
    ...
    <p class="mt-2 text-base text-gray-700">{{ __('Entrez votre courriel et nous vous enverrons un lien de réinitialisation.') }}</p>
            ...
            <div>
                ...
                <div class="mt-2 relative">
                    ...
                    <input wire:model="email" type="email" id="forgot-email" autocomplete="email"
                           ...
                           placeholder="{{ __('votre@courriel.com') }}" required autofocus aria-required="true" aria-describedby="forgot-email-error">
                </div>
                @error('email')<p class="text-red-600 text-sm mt-1" id="forgot-email-error" role="alert">{{ $message }}</p>@enderror
            </div>
    ...
    <div class="mt-6 text-center">
        <a href="{{ route('login') }}" class="font-medium text-sky-800 transition-all duration-200 hover:text-sky-800 focus:text-sky-800 hover:underline" wire:navigate>
