...
class UserArticleController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        return redirect()->route('user.articles.index')->with('success', __('Article créé avec succès.'));
    }
    ...
    public function update(Request $request, Article $article): RedirectResponse
    {
        ...
        return redirect()->route('user.articles.index')->with('success', __('Article mis à jour.'));
    }
    ...
    public function destroy(Article $article): RedirectResponse
    {
        ...
        return redirect()->route('user.articles.index')->with('success', __('Article supprimé.'));
    }
}
