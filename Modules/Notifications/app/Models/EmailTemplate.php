...
{
    use HasActiveScope, HasFactory, HasRevisions, LogsActivity;
    ...
    {
        return Cache::remember("email_template.{$slug}", config('cache-ttl.email_templates', 3600), fn () => static::active()->where('slug', $slug)->first());
    }
