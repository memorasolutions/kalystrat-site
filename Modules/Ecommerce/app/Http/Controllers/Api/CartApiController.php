...
use Modules\Ecommerce\Http\Resources\CartItemResource;
...
class CartApiController extends BaseApiController
{
    ...
    public function addItem(Request $request): JsonResponse
    {
        ...
        return $this->respondCreated(new CartItemResource($item->load('variant.product')));
    }
    ...
    public function updateItem(Request $request, CartItem $item): JsonResponse
    {
        ...
        return $this->respondSuccess(new CartItemResource($item->load('variant.product')));
    }
