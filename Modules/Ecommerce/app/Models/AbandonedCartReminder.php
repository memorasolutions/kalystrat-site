...
use Modules\Ecommerce\Database\Factories\AbandonedCartReminderFactory;
...
class AbandonedCartReminder extends Model
{
    ...
    protected static function newFactory(): AbandonedCartReminderFactory
    {
        return AbandonedCartReminderFactory::new();
    }
}
