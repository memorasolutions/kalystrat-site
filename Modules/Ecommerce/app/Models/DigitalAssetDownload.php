...
use Modules\Ecommerce\Database\Factories\DigitalAssetDownloadFactory;
...
class DigitalAssetDownload extends Model
{
    ...
    protected static function newFactory(): DigitalAssetDownloadFactory
    {
        return DigitalAssetDownloadFactory::new();
    }
}
