...
test('seeder creates 4 ecommerce email templates', function () {
    ...
    expect(EmailTemplate::where('module', 'ecommerce')->count())->toBe(6);
});
...
test('all 6 templates render without leftover placeholders', function () {
    (new EcommerceEmailTemplateSeeder)->run();
    ...
    $dummyData['product'] = ['name' => 'Widget', 'sku' => 'WDG-001', 'stock' => '2', 'threshold' => '5', 'id' => '1'];
