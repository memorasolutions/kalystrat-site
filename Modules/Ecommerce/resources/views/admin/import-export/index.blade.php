...
@section('title', __('Import / Export produits'))
...
<div class="row">
    ...
    <div class="col-md-6 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h6 class="card-title">{{ __('Exporter les produits') }}</h6>
                <p class="text-muted">{{ __('Télécharger tous les produits et variantes au format CSV.') }}</p>
    ...
    <div class="col-md-6 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h6 class="card-title">{{ __('Importer des produits') }}</h6>
...
<div class="row">
    <div class="col-md-12">
        <div class="alert alert-warning">
            <h6>{{ __("Erreurs d'importation :") }}</h6>
            <ul class="mb-0">
