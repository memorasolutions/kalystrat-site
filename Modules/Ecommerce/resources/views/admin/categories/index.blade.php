...
@extends('admintabler::layouts.admin', ['title' => __('Catégories'), 'subtitle' => __('Boutique')])
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-end pe-4">
                            <a href="{{ route('admin.ecommerce.categories.edit', $category) }}" class="btn btn-sm btn-light" aria-label="{{ __('Modifier') }}"><i data-lucide="edit-2" class="icon-sm"></i></a>
