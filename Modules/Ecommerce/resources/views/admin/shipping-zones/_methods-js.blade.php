        ...
        <div class="card mb-3 border method-row" id="method-row-${idx}">
            <div class="card-body p-3">
                <div class="d-flex justify-content-between mb-2">
                    <h6 class="fw-bold text-muted small">{{ __('Nouvelle méthode') }}</h6>
                ...
                <div class="row g-3">
                    <div class="col-md-4">
                        ...
                        <input type="text" name="methods[n${idx}][name]" class="form-control form-control-sm" placeholder="{{ __('Ex: Standard') }}" required>
                    </div>
                    <div class="col-md-2">
                        <label class="form-label small">Type</label>
                        <select name="methods[n${idx}][type]" class="form-select form-select-sm">
                            <option value="flat_rate">{{ __('Forfaitaire') }}</option>
                            <option value="free">{{ __('Gratuit') }}</option>
                            <option value="per_weight">{{ __('Par poids') }}</option>
