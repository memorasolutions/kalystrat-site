...
@extends('admintabler::layouts.admin', ['title' => __('Avis clients'), 'subtitle' => __('Boutique')])
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">
                                        ...
                                        <form action="{{ route('admin.ecommerce.reviews.approve', $review) }}" method="POST" class="d-inline">
                                            @csrf
                                            @method('PATCH')
                                            <button type="submit" class="btn btn-outline-success btn-sm" title="{{ __('Approuver') }}" aria-label="{{ __('Approuver') }}">
