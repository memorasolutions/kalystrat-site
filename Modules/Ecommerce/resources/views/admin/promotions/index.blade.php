...
@extends('admintabler::layouts.admin', ['title' => __('Promotions'), 'subtitle' => __('Boutique')])
                        ...
                        <tbody>
                            @foreach($promotions as $promotion)
                                <tr>
                                    ...
                                    <td class="text-end">
                                        <a href="{{ route('admin.ecommerce.promotions.edit', $promotion) }}" class="btn btn-outline-primary btn-sm" title="{{ __('Modifier') }}" aria-label="{{ __('Modifier') }}">
                                        ...
                                        <form action="{{ route('admin.ecommerce.promotions.destroy', $promotion) }}" method="POST" class="d-inline" onsubmit="return confirm('{{ __('Supprimer cette promotion ?') }}')">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="btn btn-outline-danger btn-sm" title="{{ __('Supprimer') }}" aria-label="{{ __('Supprimer') }}">
