...
<div class="page-content">
    <div class="d-flex align-items-center justify-content-between mb-4">
        ...
        <div class="d-flex gap-2">
            ...
            <a href="{{ route('admin.tenants.edit', $tenant) }}" class="btn btn-primary">
                <i data-lucide="edit"></i> {{ __('Modifier') }}
            </a>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-lg-4 mb-4">
                ...
                <div class="card-body p-0">
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item d-flex justify-content-between">
                            <span class="text-muted">{{ __('Nom') }}</span>
                            <span class="fw-medium">{{ $tenant->name }}</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between">
                            <span class="text-muted">{{ __('Slug') }}</span>
                            <code>{{ $tenant->slug }}</code>
                        </li>
                        <li class="list-group-item d-flex justify-content-between">
                            <span class="text-muted">{{ __('Domaine') }}</span>
                            <span>{{ $tenant->domain ?? '-' }}</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between">
                            <span class="text-muted">{{ __('Propriétaire') }}</span>
            ...
            <div class="card mt-3">
                <div class="card-header">
                    <h6 class="card-title mb-0">{{ __('Paramètres') }}</h6>
                </div>
                <div class="card-body">
        ...
        <div class="col-lg-8 mb-4">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h6 class="card-title mb-0">{{ __('Équipes associées') }}</h6>
                ...
                <div class="card-body p-0">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover mb-0 align-middle">
                            <thead>
                                <tr>
                                    <th>{{ __('Nom') }}</th>
                                    <th class="text-center">{{ __('Membres') }}</th>
                                </tr>
                            </thead>
                            <tbody>
                    ...
                    <div class="text-center py-4 text-muted">
                        ...
                        <p class="mb-0">{{ __('Aucune équipe associée') }}</p>
                    </div>
                    @endif
                </div>
            </div>
