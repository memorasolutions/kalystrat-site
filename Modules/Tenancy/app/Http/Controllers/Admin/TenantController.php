...
class TenantController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        return redirect()->route('admin.tenants.index')
            ->with('success', __('Tenant créé avec succès.'));
    }
    ...
    public function show(Tenant $tenant): View
    {
        ...
        $teams = class_exists(Team::class)
            ? Team::where('tenant_id', $tenant->id)->withCount('members')->get()
            : collect();
    ...
    public function update(Request $request, Tenant $tenant): RedirectResponse
    {
        ...
        return redirect()->route('admin.tenants.index')
            ->with('success', __('Tenant mis à jour avec succès.'));
    }
    ...
    public function destroy(Tenant $tenant): RedirectResponse
    {
        ...
        return redirect()->route('admin.tenants.index')
            ->with('success', __('Tenant supprimé avec succès.'));
    }
}
