...
class CheckoutController extends Controller
{
    ...
    public function checkout(Request $request): RedirectResponse
    {
        ...
        if (empty($plan->stripe_price_id)) {
            return back()->with('error', __('Ce plan n\'est pas encore disponible pour le paiement.'));
        }
    ...
    public function success(Request $request): View
    {
        ...
        session()->flash('success', __('Votre abonnement a été activé avec succès !'));
    ...
    {
        session()->flash('info', __('Le paiement a été annulé. Aucun montant n\'a été débité.'));
