...
use Modules\SaaS\Console\SendTrialExpiryNotifications;
...
class SaaSServiceProvider extends BaseModuleServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->singleton(SaasMetricsService::class);
        $this->app->singleton(MeteringService::class);
    ...
    {
        $this->commands([
            SendTrialExpiryNotifications::class,
        ]);
    }
