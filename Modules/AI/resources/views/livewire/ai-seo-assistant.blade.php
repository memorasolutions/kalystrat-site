...
<div class="card shadow-sm">
    ...
    <div class="card-body">
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="seoTitleInput" wire:model="title" placeholder="{{ __('Titre de l\'article') }}">
        </div>

        <div class="mb-4">
            <label for="seoContentInput" class="form-label">Contenu de l'article</label>
            <textarea class="form-control" id="seoContentInput" rows="4" wire:model="content" placeholder="{{ __('Contenu de l\'article') }}"></textarea>
        </div>
        ...
        <div class="mt-4 pt-4 border-top">
            <h6 class="mb-3">{{ __('Résultats SEO générés') }}</h6>
