        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="imageEditorLabel">{{ __('Modifier l\'image') }}</h5>
                ...
                <div class="modal-body p-0 bg-dark d-flex justify-content-center align-items-center" style="min-height:400px;max-height:70vh;overflow:hidden;">
                    <img id="imageToCrop" :src="imageUrl" style="max-width:100%;display:block;" alt="{{ __('Image source') }}">
                </div>
                <div class="modal-footer justify-content-between">
                    <div class="btn-group" role="group">
                        <button type="button" class="btn btn-outline-secondary" @click="doRotate(-90)" title="{{ __('Rotation gauche') }}" aria-label="Rotation gauche">
                            <i data-lucide="rotate-ccw" style="width:18px;height:18px;"></i>
                        </button>
                        <button type="button" class="btn btn-outline-secondary" @click="doRotate(90)" title="{{ __('Rotation droite') }}" aria-label="Rotation droite">
    ...
    return {
        ...
        async doSave() {
            ...
            try {
                ...
                alert('{{ __("Erreur lors du recadrage.") }}');
            } finally {
