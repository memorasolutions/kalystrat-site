            ...
            <div class="row gx-60 align-items-center flex-row-reverse">
                ...
                <div class="col-xl-6">
                    ...
                    <div class="btn-group mt-60">
                        <a href="{{ route('frontend.about') }}" class="btn style3">Explore Our Company <i class="ri-arrow-right-up-line"></i></a>
                    </div>                
                </div>
            </div>
        </div>
                ...
                <div class="row gy-30 gx-30 global-carousel" data-slide-show="1" data-dots="true" data-xl-dots="true" data-ml-dots="true" data-lg-dots="true" data-md-dots="true" data-center-mode="true" data-xl-center-mode="true" data-ml-center-mode="true" data-center-padding="265px" data-xl-center-padding="265px" data-ml-center-padding="200px">
                    <div class="col-lg-6">
                        <div class="portfolio-card">
                            ...
                            <a href="{{ route('frontend.portfolio') }}" class="btn">Explore Service <i class="ri-arrow-right-up-line"></i></a>                          
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="portfolio-card">
            ...
            <div class="row gx-100 gy-60 flex-row-reverse">                
                ...
                <div class="col-xl-6">
                    <div class="testimonial-card" data-bg-src="{{ asset('assets/construz-new/img/bg/testimonial-card-bg1-1.png') }}">
                        ...
                        <div class="btn-group">
                            <a href="{{ route('frontend.contact') }}" class="btn style6">Contact with Us <i class="ri-arrow-right-up-line"></i></a>
                        </div>
                    </div>
                </div>
            </div>         
        ...
        <div class="container">
            <div class="row justify-content-between align-items-center">
                <div class="col-lg-7 col-md-7">
                    <div class="title-area text-md-start text-center">
                        <span class="sub-title"><img src="{{ asset('assets/construz-new/img/icon/section-subtitle-icon.svg') }}" alt="img">Our Team</span>
                        <h2 class="sec-title">Meet our leadership</h2>
                    </div>
                </div>
                <div class="col-md-auto">
                    <div class="sec-btn">
                        <a href="{{ route('frontend.about') }}" class="btn">View All Members <i class="ri-arrow-right-up-line"></i></a>
                    </div>
                </div>
            </div>
