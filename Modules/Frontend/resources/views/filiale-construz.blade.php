                ...
                <div class="col-lg-12">
                    <div class="breadcumb-content">
                        ...
                        <ul class="breadcumb-menu">
                            ...
                            <li><a href="{{ route('frontend.services') }}">OUR SERVICE</a></li>
                        ...
                        <div class="row gy-4 justify-content-center">
                            <div class="col-xl-4 col-lg-6">
                                <div class="service-card style4">
                                    ...
                                    <div class="service-card_content">
                                        <h4 class="service-card_title"><a href="{{ route('frontend.filiale', 'fondations') }}">Full Principal Contractor service</a></h4>
                            ...
                            <div class="col-xl-4 col-lg-6">
                                <div class="service-card style4">
                                    ...
                                    <div class="service-card_content">
                                        <h4 class="service-card_title"><a href="{{ route('frontend.filiale', 'fondations') }}">Full-time Onsite Supervision</a></h4>
                                        <p class="service-card_text">There are many passages of lorem ipsum available</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-4 col-lg-6">
                                <div class="service-card style4">
                                    ...
                                    <div class="service-card_content">
                                        <h4 class="service-card_title"><a href="{{ route('frontend.filiale', 'fondations') }}">Timber and steel frame construction</a></h4>
                                        <p class="service-card_text">There are many passages of lorem ipsum available</p>
                                    </div>
                                </div>
                            </div>
