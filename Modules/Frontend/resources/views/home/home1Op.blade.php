...
@section('content')
    ...
    Hero Area
    ==============================-->
    <div class="hero-wrapper hero-1" id="hero-sec" data-bg-src="{{ asset('themes/construz/assets/img/hero/hero_bg_1_1.png') }}">
        ...
        <div class="slider-controller-wrap">
            <div class="slider-btn-wrap">
                <div class="icon-box">
                    <button data-slick-prev=".hero-slider1" class="slick-arrow default"><i class="ri-arrow-left-down-line"></i></button>
                    <button data-slick-next=".hero-slider1" class="slick-arrow default"><i class="ri-arrow-right-up-line"></i></button>
                </div>
        ...
        <div class="hero-shape1-1 shape-mockup movingX">
    ...
    About Area  
    ==============================-->
    <div class="about-area-1 space overflow-hidden" id="about-sec">
    ...
    Service Area 01  
    ==============================-->
    <div class="service-area-1 space-top overflow-hidden" id="service-sec" data-bg-src="{{ asset('themes/construz/assets/img/bg/service-bg1-1.png') }}">
        <div class="container">
    ...
    <div class="cta-area-1">
        <div class="container">
            <div class="row gx-0 align-items-center">
                <div class="col-lg-7">
                    <div class="cta-wrap-1 position-relative">
    ...
    Process Area  
    ==============================-->
    <section class="process-area-1 space-top bg-attachment process-bg-half" data-bg-src="{{ asset('themes/construz/assets/img/bg/process-bg1-1.png') }}" data-overlay="title" data-opacity="8">
    ...
    Portfolio Area  
    ==============================-->
    <div class="portfolio-area-1 space" id="project-sec">
        <div class="container">
            <div class="title-area text-center">
    ...
    Blog Area  
    ==============================-->
    <section class="blog-area-1 space" id="blog-sec">
    ...
    Contact Area  
    ==============================-->
    <section class="contact-area-1 space bg-title overflow-hidden" id="contact-sec" data-bg-src="{{ asset('themes/construz/assets/img/bg/contact-bg1-1.png') }}">
