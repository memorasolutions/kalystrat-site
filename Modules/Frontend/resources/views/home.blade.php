					...
					<div class="row clearfix">
						...
						<div class="col-lg-6 col-md-12 col-sm-12">
							...
							<div class="subscribe-box">
								<form method="post" action="contact.html">
									<div class="form-group">
										<input type="email" name="search-field" value="" placeholder="Your email here" required>
						...
						<div class="row clearfix">
							...
							<div class="footer-column col-lg-7 col-md-6 col-sm-12">
								<div class="footer-widget logo-widget">
									<h4>about</h4>
									<div class="text">Nostrud exerc itation ullamco laboris nisi ut aliqmpor incididunt ut labore et dolore magna aliqua. Ut enim ad min im veniam, quis nostrud</div>
									<!-- Social Box -->
