        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 wow fadeInRight">
                    ...
                    <a href="{{ route('frontend.about') }}" class="link-btn">En savoir plus <i class="ri-arrow-right-line"></i></a>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row gx-30 gy-30">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-card">
                        ...
                        <a href="{{ route('frontend.services') }}" class="link-btn">En savoir plus <i class="ri-arrow-right-line"></i></a>
                    </div>
                </div>
