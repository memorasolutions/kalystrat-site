        ...
        <div class="row justify-content-center">
            <div class="col-lg-9">
                ...
                @php
                    ...
                    $creditsRetracer = [
                        ['name' => 'Stock Pexels (slug d\'origine non conservé)', 'source' => 'Pexels', 'url' => 'https://www.pexels.com', 'usage' => 'hero/slide-1-montreal-chantier.webp – slide hero accueil 1 – chantier urbain'],
                        ['name' => 'Stock Pexels (slug d\'origine non conservé)', 'source' => 'Pexels', 'url' => 'https://www.pexels.com', 'usage' => 'hero/slide-2-vieux-quebec.webp – slide hero accueil 2 – Vieux-Québec, repère identitaire'],
                        ['name' => 'Stock Pexels (slug d\'origine non conservé)', 'source' => 'Pexels', 'url' => 'https://www.pexels.com', 'usage' => 'hero/slide-3-excavator.webp – slide hero accueil 3 – excavation chantier'],
                        ['name' => 'Stock Pexels (slug d\'origine non conservé)', 'source' => 'Pexels', 'url' => 'https://www.pexels.com', 'usage' => 'cta-quebec-1280w.webp – section CTA finale accueil – vue drone Québec présumée'],
                        ['name' => 'Stock Pexels (slug d\'origine non conservé)', 'source' => 'Pexels', 'url' => 'https://www.pexels.com', 'usage' => 'project-residential.webp – carte projet maison neuve accueil'],
                    ];
                    $creditsHistoriques = [
                        ...
                        ['name' => 'Thème Construz (template HTML, licence commerciale)', 'source' => 'Construz Theme', 'url' => 'https://themeforest.net', 'usage' => 'Icônes décoratives SVG/PNG du dossier assets/construz-new/img/ (icon, shape, bg) – éléments graphiques inclus dans la licence du template'],
                    ];

                    $sections = [
                        ['heading' => 'Photos d\'accueil et bandeaux', 'rows' => $creditsAccueil],
                        ['heading' => 'Photos des six filiales Kalystrat', 'rows' => $creditsFiliales],
                        ['heading' => 'Photos cartes carrières et projets', 'rows' => $creditsCarrieresProjets],
                        ['heading' => 'Photos à retracer (séance photo Q3 2026)', 'rows' => $creditsRetracer],
                        ['heading' => 'Éléments décoratifs et vignettes historiques', 'rows' => $creditsHistoriques],
                    ];
                @endphp

                @foreach($sections as $section)
                <section style="margin-bottom: 2.5rem;">
                    <h3 style="color: var(--ks-navy); font-size: 1.25rem; font-weight: 700; margin: 0 0 1rem; padding-bottom: 0.5rem; border-bottom: 2px solid var(--ks-gold);">{{ $section['heading'] }}</h3>
                    <div class="table-responsive">
                        <table style="width: 100%; border-collapse: collapse; background: #FFFFFF; border: 1px solid #E9E9E6; border-radius: 0.5rem; overflow: hidden;">
                            <caption class="visually-hidden">{{ $section['heading'] }}</caption>
                            <thead>
