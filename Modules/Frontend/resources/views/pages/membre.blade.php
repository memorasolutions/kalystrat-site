...
$membres = [
    'ali-salomon' => [
        ...
        'role_groupe' => "À titre de Président, il supervise la stratégie globale, la gouvernance, les acquisitions et l’allocation des ressources entre les filiales. Chaque direction de filiale relève directement de lui, ce qui assure une exécution alignée sur la vision du holding.",
...
<header class="ks-page-hero">
    <div class="ks-container">
        ...
        <span class="ks-eyebrow" style="color:var(--ks-gold-500);margin-bottom:1rem;display:block">{{ $m['role'] }}</span>
        <h1>{{ $m['nom'] }}</h1>
