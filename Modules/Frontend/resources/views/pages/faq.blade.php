...
$faqs = [
    ...
    ['q' => "Dans quelles villes Kalystrat opère-t-elle&nbsp;?", 'r' => "Kalystrat dessert la région de Québec (Capitale-Nationale) et la rive-sud immédiate&nbsp;: Québec, Lévis, Sainte-Foy, Beauport, Sillery et le Vieux-Québec. Le siège social est à Québec."],
    ...
    ['q' => "Pourquoi opter pour des fenêtres triple vitrage&nbsp;?", 'r' => "Le triple vitrage améliore l’isolation thermique (facteur U &le; 1,4 W/m²·K), réduit les pertes de chaleur en hiver et limite la condensation. Le Code de l’énergie du Québec rend ce niveau de performance quasi obligatoire dans la zone climatique 7A de la région de Québec."],
