...
@extends('admintabler::layouts.admin', ['title' => 'Soumission #' . $submission->id])
...
<div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
    ...
    <div class="d-flex gap-2">
        ...
        <form action="{{ route('admin.formbuilder.forms.submissions.destroy', [$form, $submission]) }}" method="POST">
            @csrf
            @method('DELETE')
            <button type="button" class="btn btn-danger" onclick="if(confirm('{{ __("Supprimer définitivement ?") }}')) this.form.submit()">
...
<div class="row">
    <div class="col-md-8 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h6 class="card-title">{{ __('Données soumises') }}</h6>
                <dl class="row mb-0">
    ...
    <div class="col-md-4 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h6 class="card-title">{{ __('Métadonnées') }}</h6>
