...
class FormController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        return redirect()->route('admin.formbuilder.forms.index')
            ->with('success', __('Formulaire créé avec succès.'));
    }
    ...
    public function update(Request $request, Form $form): RedirectResponse
    {
        ...
        return redirect()->back()->with('success', __('Formulaire mis à jour.'));
    }
    ...
    public function destroy(Form $form): RedirectResponse
    {
        ...
        return redirect()->back()->with('success', __('Formulaire supprimé.'));
    }
}
