...
it('analytics page shows top services', function () {
    $customer = BookingCustomer::factory()->create();
    $serviceA = BookingService::factory()->create(['name' => 'Massage']);
    $serviceB = BookingService::factory()->create(['name' => 'Acupuncture']);
...
it('csv export contains appointment data', function () {
    $customer = BookingCustomer::factory()->create();
    $service = BookingService::factory()->create(['name' => 'Ostéopathie']);
