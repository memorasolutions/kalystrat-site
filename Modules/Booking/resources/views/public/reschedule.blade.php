...
<div class="container py-5">
    <h2 class="mb-4">{{ __('Replanifier votre rendez-vous') }}</h2>
    ...
    <div class="card mb-4 border-info">
        <div class="card-header bg-info text-white">
            <h5 class="mb-0">{{ __('Rendez-vous actuel') }}</h5>
        </div>
        <div class="card-body">
    ...
    <div class="card">
        <div class="card-header"><h5 class="mb-0">{{ __('Sélectionner une nouvelle date') }}</h5></div>
        <div class="card-body">
