...
@extends('backoffice::themes.backend.layouts.admin', ['title' => __('Paramètres de réservation'), 'subtitle' => __('Réservations')])

@section('content')
<div class="card">
    <div class="card-header"><h5 class="mb-0">{{ __('Paramètres de réservation') }}</h5></div>
    <div class="card-body">
