...
@extends('backoffice::themes.backend.layouts.admin', ['title' => __('Clients'), 'subtitle' => __('Réservations')])
...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-header"><h5 class="mb-0">{{ __('Liste des clients') }}</h5></div>
        <div class="card-body p-0">
                    ...
                    <table class="table table-hover mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-end">
                                    <a href="{{ route('admin.booking.customers.show', $customer) }}" class="btn btn-sm btn-outline-primary" aria-label="{{ __('Voir') }}">
                                        <i data-lucide="eye"></i>
                                    </a>
                                </td>
                            </tr>
            ...
            @else
                <div class="text-center py-5 text-muted">{{ __('Aucun client trouvé') }}</div>
            @endif
        </div>
