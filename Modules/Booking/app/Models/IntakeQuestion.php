...
use Modules\Booking\Database\Factories\IntakeQuestionFactory;
...
class IntakeQuestion extends Model
{
    ...
    protected static function newFactory(): IntakeQuestionFactory
    {
        return IntakeQuestionFactory::new();
    }
}
