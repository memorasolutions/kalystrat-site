...
use Modules\Booking\Database\Factories\RecurringAppointmentFactory;
...
class RecurringAppointment extends Model
{
    ...
    protected static function newFactory(): RecurringAppointmentFactory
    {
        return RecurringAppointmentFactory::new();
    }
}
