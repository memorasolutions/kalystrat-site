...
<body class="bg-light d-flex align-items-center justify-content-center" style="min-height:100vh;">
    <div class="card shadow-sm" style="max-width:400px;width:100%;">
        <div class="card-body p-4 text-center">
            ...
            <h5 class="fw-semibold mb-1">{{ __('Lien protégé') }}</h5>
            <p class="text-muted small mb-4">{{ __('Ce lien nécessite un mot de passe pour y accéder.') }}</p>
            ...
            <form method="POST" action="{{ route('short-url.password', $slug) }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="password" name="password" id="password"
                           ...
                           placeholder="{{ __('Mot de passe') }}" required autofocus>
                    @error('password')
