...
<div class="container-fluid">
    ...
    <div class="row">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.email-templates.update', $emailTemplate) }}">
                        ...
                        <div class="d-flex gap-2 flex-wrap">
                            <button type="submit" class="btn btn-primary rounded-2">{{ __('Sauvegarder') }}</button>
                    ...
                    <form method="POST" action="{{ route('admin.email-templates.reset', $emailTemplate) }}" class="mt-3" x-data onsubmit="return confirm('{{ __("Restaurer ce template aux valeurs par défaut ?") }}')">
                        @csrf
        ...
        <div class="col-lg-4">
            <div class="card rounded-2">
                <div class="card-header bg-light">
                    <h5 class="mb-0">{{ __('Variables disponibles') }}</h5>
                </div>
