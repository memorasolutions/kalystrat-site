...
@extends('admintabler::layouts.admin', ['title' => __('Personnalisation'), 'subtitle' => __('Apparence du site')])

@section('breadcrumbs')
    <x-backoffice::breadcrumb :items="[
        ['label' => __('Configuration'), 'route' => 'admin.settings.index'],
