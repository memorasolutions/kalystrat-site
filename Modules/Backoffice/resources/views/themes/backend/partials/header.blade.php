...
<nav class="navbar">
    <div class="navbar-content">
        ...
        <ul class="navbar-nav">
            ...
            <li class="theme-switcher-wrapper nav-item d-none d-md-flex">
            ...
            {{-- Language switcher (desktop only, mobile in avatar hub) --}}
            <li class="nav-item dropdown d-none d-md-flex">
                <a class="nav-link dropdown-toggle d-flex align-items-center" href="#" id="languageDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    ...
                    @else
                        <img src="{{ asset('build/nobleui/plugins/flag-icons/flags/4x3/us.svg') }}" class="w-20px" alt="{{ __('American flag') }}">
                        <span class="ms-2 d-none d-md-inline-block">{{ __('English') }}</span>
                    @endif
                </a>
                <div class="dropdown-menu" aria-labelledby="languageDropdown">
                    ...
                    <a href="{{ route('locale.switch', 'en') }}" class="dropdown-item py-2 d-flex">
                        <img src="{{ asset('build/nobleui/plugins/flag-icons/flags/4x3/us.svg') }}" class="w-20px" alt="{{ __('Drapeau américain') }}">
                        <span class="ms-2">{{ __('English') }}</span>
                    </a>
                </div>
            </li>

            {{-- Guided tour restart (desktop only, mobile in avatar hub) --}}
            ...
            {{-- Notifications (desktop only, mobile in avatar hub) --}}
            <li class="nav-item dropdown d-none d-md-flex">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu p-0" aria-labelledby="profileDropdown">
                    ...
                    <ul class="list-unstyled p-1">
                        {{-- Mobile-only: preferences hub (hidden on desktop) --}}
                        <li class="d-md-none">
                            <h6 class="dropdown-header text-uppercase small fw-bold">{{ __('Preferences') }}</h6>
                        </li>
                        <li class="d-md-none">
                            <div class="dropdown-item py-2 d-flex align-items-center justify-content-between">
                                <span><i class="me-2 icon-md" data-lucide="moon"></i>{{ __('Mode sombre') }}</span>
                                <div class="form-check form-switch mb-0">
                                    <input class="form-check-input" type="checkbox" id="mobileDarkMode" onchange="document.getElementById('theme-switcher').click()">
                                </div>
                            </div>
                        </li>
                        <li class="d-md-none">
                            <div class="dropdown-item py-2 d-flex align-items-center justify-content-between">
                                <span><i class="me-2 icon-md" data-lucide="globe"></i>{{ __('Langue') }}</span>
                                <div>
                                    <a href="{{ route('locale.switch', 'fr') }}" class="btn btn-sm {{ app()->getLocale() === 'fr' ? 'btn-primary' : 'btn-outline-secondary' }} px-2 py-0">FR</a>
                                    <a href="{{ route('locale.switch', 'en') }}" class="btn btn-sm {{ app()->getLocale() === 'en' ? 'btn-primary' : 'btn-outline-secondary' }} px-2 py-0">EN</a>
                                </div>
                            </div>
                        </li>
                        <li class="d-md-none">
                            <a href="{{ route('admin.notifications.index') }}" class="dropdown-item py-2 text-body ms-0 d-flex align-items-center justify-content-between">
                                <span><i class="me-2 icon-md" data-lucide="bell"></i>{{ __('Notifications') }}</span>
