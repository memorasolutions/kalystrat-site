...
@extends('admintabler::layouts.admin', ['title' => __('SEO'), 'subtitle' => __('Nouveau tag')])
        ...
        <form method="POST" action="{{ route('admin.seo.store') }}">
            ...
            <div class="row g-4 mb-4">
                <div class="col-12 col-md-6">
                    ...
                    <input type="text"
                           ...
                           placeholder="{{ __('/blog ou /blog/*') }}" required>
                ...
                <div class="col-12 col-md-6">
                    ...
                    <input type="text"
                           ...
                           placeholder="{{ __('Titre optimisé SEO') }}" maxlength="255">
            ...
            <div class="mb-4">
                ...
                <textarea class="form-control @error('description') is-invalid @enderror"
                          ...
                          placeholder="{{ __('Description optimisée SEO...') }}">{{ old('description') }}</textarea>
            ...
            <div class="mb-4">
                ...
                <input type="text"
                       ...
                       placeholder="{{ __('laravel, saas, boilerplate') }}" maxlength="500">
            ...
            <div class="row g-4 mb-4">
                <div class="col-12 col-md-6">
                    ...
                    <input type="text"
                           ...
                           placeholder="{{ __('Titre pour les réseaux sociaux') }}" maxlength="255">
            ...
            <div class="mb-4">
                ...
                <textarea class="form-control @error('og_description') is-invalid @enderror"
                          ...
                          placeholder="{{ __('Description pour les réseaux sociaux') }}">{{ old('og_description') }}</textarea>
