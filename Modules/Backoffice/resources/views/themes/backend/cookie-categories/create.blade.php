...
@extends('admintabler::layouts.admin', ['title' => __('Catégories cookies'), 'subtitle' => __('Créer')])
            ...
            <div class="row g-4">
                ...
                <div class="col-12 col-md-6">
                    ...
                    <input type="text" name="name" id="name"
                        ...
                        value="{{ old('name') }}" required aria-required="true" placeholder="{{ __('ex: preferences') }}" autocomplete="off">
                    @error('name')
                ...
                <div class="col-12 col-md-6">
                    ...
                    <input type="text" name="label" id="label"
                        ...
                        value="{{ old('label') }}" required aria-required="true" placeholder="{{ __('ex: Cookies de préférences') }}" autocomplete="off">
                    @error('label')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
