...
<div>
    ...
    <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-3">
        ...
        <select wire:model.live="perPage" class="form-select form-select-sm w-auto" aria-label="{{ __('Éléments par page') }}">
        ...
        <table class="table table-hover">
            ...
            <tbody>
                @forelse($users as $user)
                    <tr>
                        <td>
                            <input type="checkbox" wire:model.live="selected" value="{{ $user->id }}" class="form-check-input" style="cursor:pointer" aria-label="{{ __('Sélectionner') }}">
                        </td>
                        <td>
                            <div class="d-flex align-items-center gap-3"
                                ...
                                <span class="fw-medium" x-show="!editing"
                                      @dblclick="editing = true" title="{{ __('Double-clic pour modifier') }}" style="cursor:text;">
                                    {{ $user->name }}
                                </span>
                                <input type="text"
                                       class="form-control form-control-sm"
