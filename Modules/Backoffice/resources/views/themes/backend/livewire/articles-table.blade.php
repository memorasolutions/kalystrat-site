...
<div>
    ...
    <div class="border-bottom pb-3 mb-3">
        <div class="d-flex flex-wrap align-items-center gap-3">
            ...
            <select wire:model.live="filterCategory" class="form-select form-select-sm w-auto" aria-label="{{ __('Filtrer par catégorie') }}">
        ...
        <div class="table-responsive">
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <input type="checkbox" wire:model.live="selected" value="{{ $article->id }}" class="form-check-input" style="cursor:pointer" aria-label="{{ __('Sélectionner') }}">
                        </td>
                        <td>
