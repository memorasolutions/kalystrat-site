...
<div>
    ...
    <div class="d-flex flex-wrap align-items-center gap-3 mb-3">
        <select wire:model.live="filterType" class="form-select form-select-sm w-auto" aria-label="{{ __('Filtrer par type') }}">
            <option value="">{{ __('Tous les types') }}</option>
            <option value="image">{{ __('Images') }}</option>
            <option value="document">{{ __('Documents') }}</option>
            <option value="video">{{ __('Vidéos') }}</option>
        </select>
        <select wire:model.live="filterFolder" class="form-select form-select-sm w-auto" aria-label="{{ __('Filtrer par dossier') }}">
        ...
        <div class="position-fixed top-0 start-0 w-100 h-100 d-flex align-items-center justify-content-center" style="z-index:1050;background:rgba(0,0,0,.5);">
            <div class="card shadow-lg" style="width:100%;max-width:520px;">
                <div class="card-header d-flex align-items-center justify-content-between py-3">
                    ...
                    <button type="button" wire:click="cancelEdit" class="btn-close btn-close-sm" aria-label="{{ __('Fermer') }}"></button>
                </div>
                <div class="card-body">
                    <div class="mb-3">
