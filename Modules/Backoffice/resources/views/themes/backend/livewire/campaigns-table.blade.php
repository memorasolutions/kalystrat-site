        ...
        <table class="table table-hover">
            <thead>
                <tr class="border-bottom">
                    <th style="width:40px;">
                        <input type="checkbox" wire:model.live="selectAll" class="form-check-input" style="width:16px;height:16px;" aria-label="{{ __('Tout sélectionner') }}">
                    </th>
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <input type="checkbox" wire:model.live="selected" value="{{ $campaign->id }}" class="form-check-input" style="width:16px;height:16px;" aria-label="{{ __('Sélectionner') }}">
                    </td>
                    <td class="text-body">{{ $campaign->subject }}</td>
                    <td>
                        <select wire:change="changeStatus({{ $campaign->id }}, $event.target.value)"
                                class="form-select form-select-sm w-auto"
                                aria-label="{{ __('Changer le statut') }}"
