        ...
        <table class="table table-hover align-middle">
            <thead>
                <tr class="border-bottom">
                    <th style="width:40px;">
                        <input type="checkbox" wire:model.live="selectAll" class="form-check-input cursor-pointer" style="width:16px;height:16px;" aria-label="{{ __('Tout sélectionner') }}">
                    </th>
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <input type="checkbox" wire:model.live="selected" value="{{ $sub->id }}" class="form-check-input cursor-pointer" style="width:16px;height:16px;" aria-label="{{ __('Sélectionner') }}">
                    </td>
