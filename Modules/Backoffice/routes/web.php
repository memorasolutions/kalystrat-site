...
use Modules\ABTest\Http\Controllers\ExperimentController;
...
use Modules\Testimonials\Http\Controllers\TestimonialController;
...
Route::prefix('admin')
    ...
    ->group(function () {
        ...
        Route::get('menus/{menu}', [MenuController::class, 'show'])->name('menus.show')->middleware('permission:view_menus');
        Route::middleware('permission:update_menus')->group(function () {
            Route::get('menus/{menu}/edit', [MenuController::class, 'edit'])->name('menus.edit');
            Route::put('menus/{menu}', [MenuController::class, 'update'])->name('menus.update');
            Route::post('menus/{menu}/save-items', [MenuController::class, 'saveItems'])->name('menus.save-items');
        });
        Route::delete('menus/{menu}', [MenuController::class, 'destroy'])->name('menus.destroy')->middleware('permission:delete_menus');
        ...
        Route::get('faqs/{faq}', [FaqController::class, 'show'])->name('faqs.show')->middleware('permission:view_faqs');
        Route::delete('faqs/{faq}', [FaqController::class, 'destroy'])->name('faqs.destroy')->middleware('permission:delete_faqs');

        // ── Témoignages ──
        Route::get('testimonials', [TestimonialController::class, 'index'])->name('testimonials.index')->middleware('permission:view_testimonials');
        ...
        Route::middleware('permission:manage_feature_flags')->group(function () {
            ...
            Route::post('experiments/{experiment}/complete', [ExperimentController::class, 'complete'])->name('experiments.complete');
