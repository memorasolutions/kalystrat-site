...
use Modules\Backoffice\Database\Factories\FeatureFlagConditionFactory;
...
class FeatureFlagCondition extends Model
{
    ...
    protected static function newFactory(): FeatureFlagConditionFactory
    {
        return FeatureFlagConditionFactory::new();
    }
}
