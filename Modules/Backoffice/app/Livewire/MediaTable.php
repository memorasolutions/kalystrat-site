...
class MediaTable extends Component
{
    ...
    public function upload(): void
    {
        ...
        $this->file = null;
        $this->dispatch('toast', type: 'success', message: __('Fichier uploadé avec succès.'));
    ...
    public function updateMedia(): void
    {
        ...
        $this->dispatch('toast', type: 'success', message: __('Métadonnées mises à jour.'));
        $this->cancelEdit();
    }
    ...
    public function deleteMedia(int $id): void
    {
        $media = Media::findOrFail($id);
        $media->delete();
        $this->dispatch('toast', type: 'success', message: __('Média supprimé.'));
        $this->dispatch('$refresh');
    }
