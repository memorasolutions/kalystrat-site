...
class TranslationsManager extends Component
{
    ...
    public function updateTranslation(string $key, string $value): void
    {
        ...
        $this->dispatch('toast', message: __('Traduction mise à jour.'), type: 'success');
    }

    public function deleteKey(string $key): void
    {
        $this->service->deleteKey($key);
        $this->dispatch('toast', message: __('Clé supprimée.'), type: 'success');
    }
    ...
    public function addKey(): void
    {
        ...
        $this->dispatch('toast', message: __('Clé ajoutée.'), type: 'success');
    }
    ...
    public function addLocale(): void
    {
        ...
        $this->dispatch('toast', message: __('Langue ajoutée.'), type: 'success');
    }
    ...
    public function importLocale(): void
    {
        ...
        if (json_last_error() !== JSON_ERROR_NONE) {
            $this->dispatch('toast', message: __('Fichier JSON invalide.'), type: 'error');
        ...
        $this->dispatch('toast', message: __('Traductions importées.'), type: 'success');
    }
    ...
    public function autoTranslate(string $key): void
    {
        ...
        if (empty($sourceText)) {
            $this->dispatch('toast', message: __('Aucun texte source à traduire.'), type: 'error');
            $this->translatingKey = '';
