...
class DashboardController
{
    public function __invoke(): View
    {
        ...
        $usersByMonth = collect(range(11, 0))->map(function ($i) use ($userDates) {
            ...
            return ['label' => $localized->isoFormat('MMM'), 'count' => $userDates->get($date->format('Y-n'), 0)];
        })->values()->all();
        ...
        $articlesByMonth = collect(range(11, 0))->map(function ($i) use ($articleDates) {
            ...
            return ['label' => $localized->isoFormat('MMM'), 'count' => $articleDates->get($date->format('Y-n'), 0)];
        })->values()->all();
        ...
        return view('backoffice::dashboard.index', [
            ...
            'metricGroups' => app(MetricAggregatorService::class)->getGroupedWidgets(),
        ]);
    }
}
