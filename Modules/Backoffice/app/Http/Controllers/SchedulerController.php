...
class SchedulerController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        return redirect()->route('admin.scheduler')->with('success', __('Tâche planifiée créée.'));
    }
    ...
    public function update(Request $request, ScheduledTask $scheduledTask): RedirectResponse
    {
        ...
        return redirect()->route('admin.scheduler')->with('success', __('Tâche planifiée mise à jour.'));
    }
    ...
    public function destroy(ScheduledTask $scheduledTask): RedirectResponse
    {
        ...
        return redirect()->route('admin.scheduler')->with('success', __('Tâche planifiée supprimée.'));
    }
    ...
    public function toggle(ScheduledTask $scheduledTask): RedirectResponse
    {
        ...
        return redirect()->route('admin.scheduler')->with('success', __('Tâche :status.', ['status' => $status]));
    }
