...
class PlanController
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        return redirect()->route('admin.plans.index')->with('success', __('Plan créé.'));
    }
    ...
    public function update(Request $request, Plan $plan): RedirectResponse
    {
        ...
        return redirect()->route('admin.plans.index')->with('success', __('Plan modifié.'));
    }
    ...
    public function destroy(Plan $plan): RedirectResponse
    {
        ...
        return redirect()->route('admin.plans.index')->with('success', __('Plan supprimé.'));
    }
}
