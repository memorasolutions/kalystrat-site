...
class SettingController
{
    ...
    public function store(StoreSettingRequest $request): RedirectResponse
    {
        ...
        return redirect()->route('admin.settings.index')->with('success', __('Paramètre créé.'));
    }
    ...
    public function update(UpdateSettingRequest $request, Setting $setting): RedirectResponse
    {
        ...
        return redirect()->route('admin.settings.index')->with('success', __('Paramètre modifié.'));
    }
    ...
    public function destroy(Setting $setting): RedirectResponse
    {
        ...
        return redirect()->route('admin.settings.index')->with('success', __('Paramètre supprimé.'));
    }
}
