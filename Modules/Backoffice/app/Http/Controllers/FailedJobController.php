...
class FailedJobController
{
    ...
    public function retry(string $id): RedirectResponse
    {
        ...
        return back()->with('success', __('Job relancé avec succès.'));
    }
    ...
    public function destroy(string $id): RedirectResponse
    {
        ...
        return back()->with('success', __('Job supprimé.'));
    }
    ...
    public function destroyAll(): RedirectResponse
    {
        ...
        return back()->with('success', __('Tous les jobs échoués ont été supprimés.'));
    }
}
