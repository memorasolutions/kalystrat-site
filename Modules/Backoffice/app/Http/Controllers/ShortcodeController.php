...
class ShortcodeController
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        return redirect()->route('admin.shortcodes.index')->with('success', __('Shortcode créé avec succès.'));
    }
    ...
    public function update(Request $request, Shortcode $shortcode): RedirectResponse
    {
        ...
        return redirect()->route('admin.shortcodes.index')->with('success', __('Shortcode mis à jour avec succès.'));
    }
    ...
    public function destroy(Shortcode $shortcode): RedirectResponse
    {
        ...
        return redirect()->route('admin.shortcodes.index')->with('success', __('Shortcode supprimé avec succès.'));
    }
}
