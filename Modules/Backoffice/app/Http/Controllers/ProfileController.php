...
class ProfileController
{
    ...
    public function updatePassword(Request $request): RedirectResponse
    {
        ...
        return back()->with('success', __('Mot de passe modifié.'));
    }
    ...
    public function confirmTwoFactor(Request $request, TwoFactorService $service): RedirectResponse
    {
        ...
        return back()->with('success', __('Double authentification activée avec succès.'));
    }
    ...
    public function disableTwoFactor(Request $request, TwoFactorService $service): RedirectResponse
    {
        ...
        return back()->with('success', __('Double authentification désactivée.'));
    }
    ...
    public function revokeSession(string $id): RedirectResponse
    {
        ...
        return back()->with('success', __('Session révoquée.'));
    }
    ...
    public function revokeOtherSessions(Request $request): RedirectResponse
    {
        ...
        return back()->with('success', __('Toutes les autres sessions ont été révoquées.'));
    }
