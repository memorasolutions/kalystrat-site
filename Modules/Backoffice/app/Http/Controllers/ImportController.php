...
class ImportController extends Controller
{
    ...
    public function importUsers(Request $request): RedirectResponse
    {
        ...
        return back()->with('success', __(':imported utilisateur(s) importé(s), :skipped ignoré(s).', ['imported' => $imported, 'skipped' => $skipped]));
    }
    ...
    public function importArticles(Request $request): RedirectResponse
    {
        ...
        return back()->with('success', __(':imported article(s) importé(s), :skipped ignoré(s).', ['imported' => $imported, 'skipped' => $skipped]));
    }
    ...
    public function importCategories(Request $request): RedirectResponse
    {
        ...
        return back()->with('success', __(':imported catégorie(s) importée(s), :skipped ignorée(s).', ['imported' => $imported, 'skipped' => $skipped]));
    }
    ...
    public function importSubscribers(Request $request): RedirectResponse
    {
        ...
        return back()->with('success', __(':imported abonné(s) importé(s), :skipped ignoré(s).', ['imported' => $imported, 'skipped' => $skipped]));
    }
    ...
    public function importPlans(Request $request): RedirectResponse
    {
        ...
        return back()->with('success', __(':imported plan(s) importé(s), :skipped ignoré(s).', ['imported' => $imported, 'skipped' => $skipped]));
    }
    ...
    public function importPages(Request $request): RedirectResponse
    {
        ...
        return back()->with('success', __(':imported page(s) importée(s), :skipped ignorée(s).', ['imported' => $imported, 'skipped' => $skipped]));
    }
    ...
    public function importComments(Request $request): RedirectResponse
    {
        ...
        return back()->with('success', __(':imported commentaire(s) importé(s), :skipped ignoré(s).', ['imported' => $imported, 'skipped' => $skipped]));
    }
    ...
    public function template(string $type)
    {
        ...
        if (! isset($templates[$type])) {
            return back()->with('error', __('Type de template invalide.'));
        }

        $tempFile = sys_get_temp_dir().'/csv_'.bin2hex(random_bytes(8));
