...
class UpdateUserRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'password' => ['nullable', 'confirmed', new PasswordPolicyRule, new PasswordNotCompromisedRule, new PasswordHistoryRule(is_object($this->route('user')) ? $this->route('user')->id : $this->route('user'))],
