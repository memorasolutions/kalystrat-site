            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="validation_rules" id="validation_rules" class="form-control" value="{{ old('validation_rules', $definition->validation_rules) }}" placeholder="{{ __('ex: min:3|max:255') }}">
                    </div>
                </div>
            </div>
        </div>
