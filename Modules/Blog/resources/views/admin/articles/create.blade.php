...
@extends('admintabler::layouts.admin', ['title' => __('Nouvel article'), 'subtitle' => __('Blog')])
                    ...
                    <div @click="$refs.featuredImageInput.click()"
                        ...
                        <template x-if="!preview">
                            <div>
                                ...
                                <p class="mb-1 text-sm fw-medium">{{ __('Glissez une image ici') }}</p>
                                <p class="mb-0 small text-muted">{{ __('JPG, PNG, WebP — max 2 Mo') }}</p>
                            </div>
                        </template>
                        <template x-if="preview">
                            <div>
