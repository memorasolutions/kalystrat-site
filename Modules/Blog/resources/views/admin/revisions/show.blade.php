...
@extends('admintabler::layouts.admin', ['title' => __('Révision').' #'.$revision->revision_number, 'subtitle' => $article->title])
...
<div class="card">
    ...
    <div class="card-body p-4">
        ...
        <div class="mb-3">
            ...
            <div class="border rounded-2 p-3">{!! Purifier::clean($revision->content ?? '') !!}</div>
        </div>
    </div>
