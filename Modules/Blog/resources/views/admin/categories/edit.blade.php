...
@extends('admintabler::layouts.admin', ['title' => __('Modifier catégorie'), 'subtitle' => __('Blog')])

@section('content')
<div class="card">
    <div class="card-header">
        <h6 class="mb-0">{{ __('Modifier la catégorie') }}</h6>
    </div>
    <div class="card-body">
        <form action="{{ route('admin.blog.categories.update', $category) }}" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    <label for="color" class="form-label">{{ __('Couleur') }} <span class="text-danger">*</span></label>
