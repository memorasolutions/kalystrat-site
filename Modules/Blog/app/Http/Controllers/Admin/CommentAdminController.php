...
class CommentAdminController extends Controller
{
    ...
    public function approve(Comment $comment): RedirectResponse
    {
        ...
        return redirect()->back()->with('success', __('Commentaire approuvé.'));
    }
    ...
    public function spam(Comment $comment): RedirectResponse
    {
        ...
        return redirect()->back()->with('success', __('Commentaire marqué comme spam.'));
    }
    ...
    public function destroy(Comment $comment): RedirectResponse
    {
        ...
        return redirect()->back()->with('success', __('Commentaire supprimé définitivement.'));
    }
}
