...
class LogService
{
    ...
    public function getByLogName(string $logName, int $limit = 50): Collection
    {
    ...
    public function getByCauser(object $causer, int $limit = 50): Collection
    {
    ...
    public function getBySubject(object $subject, int $limit = 50): Collection
    {
