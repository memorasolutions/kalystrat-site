...
use Modules\AI\Database\Seeders\KnowledgeBaseSeeder;
...
class DemoSeederCommand extends Command
{
    ...
    private function seedKnowledgeBase(): void
    {
        ...
        $this->components->task('Seeding AI knowledge base', function () {
            $this->callSilent('db:seed', ['--class' => KnowledgeBaseSeeder::class]);
    ...
    private function seedEcommerce(): void
    {
        ...
        $this->components->task('Seeding ecommerce demo data', function () {
            $this->callSilent('db:seed', ['--class' => EcommerceDatabaseSeeder::class]);
    ...
    private function showSummary(): void
    {
        ...
        if (class_exists(Product::class)) {
            $rows[] = ['Products', Product::count()];
            $rows[] = ['Coupons', Coupon::count()];
        }
