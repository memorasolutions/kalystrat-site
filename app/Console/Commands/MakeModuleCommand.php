...
class MakeModuleCommand extends Command
{
    ...
    private function createReadme(string $modulePath, string $name): void
    {
        $content = <<<MD
            ...
            This module is part of the MEMORA Laravel SaaS template. It is activated via `modules_statuses.json`.
            ...
            See `routes/web.php` and `routes/api.php`.
        ...
        $this->writeFile("{$modulePath}/README.md", $this->dedentHeredoc($content));
    }
