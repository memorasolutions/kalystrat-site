<?php $__env->startSection('title', 'Kalystrat - Construction stratégique à Québec'); ?>
<?php $__env->startSection('meta_description', 'Kalystrat est votre partenaire de confiance pour la construction stratégique et le développement immobilier à Québec. Découvrez notre expertise et nos projets.'); ?>
...
<?php $__env->startSection('content'); ?>
                ...
                <div class="col-lg-8">
                    <div class="hero-style1">
                        ...
                        <div class="btn-group wow fadeInUp" data-wow-delay="0.4s">
                            <a href="<?php echo e(route('frontend.services')); ?>" class="btn">DÉCOUVRIR NOS SERVICES <i class="ri-arrow-right-up-line"></i></a>
                            <a href="<?php echo e(route('frontend.contact')); ?>" class="btn style2">SOUMISSION GRATUITE <i class="ri-arrow-right-up-line"></i></a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="counter-wrap" data-bg-src="<?php echo e(asset('assets/construz/img/bg/counter-bg1-1.png')); ?>">
        <div class="container">
            <div class="row gy-4">
        ...
        <div class="container">
            ...
            <div class="row gx-30 gy-30">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="project-card">
                        <div class="project-img">
                            <img src="<?php echo e(asset('assets/construz/img/project/project1_1.png')); ?>" alt="Projet résidentiel">
                        </div>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.2s">
                    <div class="project-card">
                        <div class="project-img">
                            <img src="<?php echo e(asset('assets/construz/img/project/project1_2.png')); ?>" alt="Développement commercial">
                        </div>
                        <div class="project-content">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="project-card">
                        <div class="project-img">
                            <img src="<?php echo e(asset('assets/construz/img/project/project1_3.png')); ?>" alt="Rénovation stratégique">
                        </div>
                        <div class="project-content">
            ...
            <div class="text-center mt-5">
                <a href="<?php echo e(route('frontend.portfolio')); ?>" class="btn">VOIR TOUT LE PORTFOLIO <i class="ri-arrow-right-up-line"></i></a>
            </div>
        </div>
    </section>
    ...
    <section class="space-top space-bottom">
        <div class="container">
            <div class="cta-wrap2 text-center">
                ...
                <a href="<?php echo e(route('frontend.contact')); ?>" class="btn wow fadeInUp" data-wow-delay="0.2s">CONTACTEZ-NOUS <i class="ri-arrow-right-up-line"></i></a>
            </div>
        </div>
    </section>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('frontend::layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/stephanelapointe/__IA__/_____SERVEUR_____/site_internet/kalystrat/Modules/Frontend/resources/views/home.blade.php ENDPATH**/ ?>